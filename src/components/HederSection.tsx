    ...
    <section>
      <div className="grid grid-cols-1 sm:grid-cols-12">
        <div className="col-span-7 place-self-center">
          ...
          <div>
            <button
              className="text-black hover:text-white bg-white hover:bg-blue-700  rounded-full w-full sm:w-fit px-4 py-4 shadow-xl shadow-blue-700 hover:shadow-white mr-4"
            >
              Hire Me
            </button>
            <button
        ...
        <div className="col-span-5 place-self-center mt-10 lg:mt-0">
          <div className="rounded-full bg-gray-600/70 shadow-blue-950 shadow-xl ml-8 w-[350px] h-[350px] lg:w-[400] lg:[400] relative">
            <Image
              src="/img/formal.png"
              alt=""
              width={240}
