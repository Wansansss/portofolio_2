    ...
    <>
     <div onClick={handleNav} className="text-white sm:hidden">
        ...
        />
          ...
          <Link href="https://www.instagram.com/rdwnardynsyh" className="flex  hover:text-blue-700 cursor-pointer text-white transition-all duration-200 ease-out" >
        <InstagramLogo size={26} />
        </Link>
        <Link href="" className="flex  hover:text-blue-700 cursor-pointer text-white transition-all duration-200 ease-out">
        <LinkedinLogo size={26} />
        </Link>
        <Link href="mailto:ridhwanardiansyah@gmail.com" className="flex  hover:text-blue-700 cursor-pointer text-white transition-all duration-200 ease-out">
        <Envelope size={28} />
        </Link>
        <Link href="https://wa.me/6285710093376" className="flex  hover:text-blue-700 cursor-pointer text-white transition-all duration-200 ease-out">
